...
<div class="container">
    <div style="padding: 20px; padding-top: 10px; background: #f8f8f8; border-style: solid; border-color: #A22C29; border-width: 0.3em;"
        class="border border-primary text-dark">
        ...
        <form action="{{ route('createQuestion')}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control-file" id="descriptionInput" placeholder="Title" name="title"
                    required autofocus>
            </div>
            <div class="form-group">
