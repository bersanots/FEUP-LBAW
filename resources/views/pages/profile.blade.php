        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="bs-ccomponent">
                    <img src="../img/{{ $user->picture }}" class="border border-primary">
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active show" id="about">
                            <div class="text-light border border-primary">
                                <fieldset>
                    ...
                    <div class="list-group">
                        @foreach ($user->notifications($user->user_id) as $notification)
                            ...
                            @elseif($notification->type == 'New answer')
                                @if($notification->has_seen == false)
                                    <a href="../questions/{{ $user->notification_resource($notification->notification_id)[0]->object_id }}" class="list-group-item list-group-item-action flex-column align-items-start active">
                                @else
